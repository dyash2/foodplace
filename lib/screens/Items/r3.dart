...
class IndividualItem8 extends StatefulWidget {
  static const routeName = "/popularrest3";

  @override
  _IndividualItemState createState() => _IndividualItemState();
}

class _IndividualItemState extends State<IndividualItem8> {
...
"The Black Sheep Bistro tempts your taste buds with an array of delectable bakery delights. Indulge in heavenly pastries, bread, and cakes in a charming ambiance. Savor the sweetness of life at this cozy bakery haven",
                                          ),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(horizontal: 20),
