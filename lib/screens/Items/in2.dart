...
class IndividualItem2 extends StatefulWidget {
  static const routeName = "/individualScreen2";

  @override
  _IndividualItemState createState() => _IndividualItemState();
}

class _IndividualItemState extends State<IndividualItem2> {
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: [
                ...
                DropdownMenuItem(
                  child: Text("Black"),
                  value: "Black", // You can set the value to the option text
                ),
                DropdownMenuItem(
                  child: Text("White"),
                  value: "White",
