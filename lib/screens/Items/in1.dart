...
class IndividualItem extends StatefulWidget {
  static const routeName = "/individualScreen1";
...
class _IndividualItemState extends State<IndividualItem> {
  String? _selectedSize1;
  String? _selectedSize2;
  int _portionCount = 1;
  int _initialPrice = 750;
  int _totalPrice = 750;
  String _itemName = "Mulberry Pizza";

  void _addToCart() {
    print("Adding to cart: $_itemName"); // Add this line for debugging
    _itemName = "Mulberry Pizza x$_portionCount Rs.$_totalPrice";
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20),
                                          child: Text(
                                              "Mulberry Pizza offers a delightful fusion of traditional and creative pizza flavors, featuring high-quality ingredients and a unique culinary twist that satisfies both classic and adventurous palates."),
                                        ),
                                        SizedBox(
                                          height: 20,
                                        ),
                                          ...
                                          child: Container(
                                            ...
                                            child: DropdownButtonHideUnderline(
                                              child: DropdownButton<String>(
                                                ...
                                                value:
                                                    _selectedSize1, // Set the selected value here
                                                onChanged: (newValue) {
                                                  setState(() {
                                                    _selectedSize1 =
                                                ...
                                                items: [
                                                  ...
                                                  DropdownMenuItem(
                                                    child: Text("Small"),
                                                    value:
                                                        "Small", // You can set the value to the option text
                                                  ),
                                                  DropdownMenuItem(
                                                    child: Text("Medium"),
                                                    value: "Medium",
                                            ...
                                            child: DropdownButtonHideUnderline(
                                              child: DropdownButton<String>(
                                                hint: Row(
                                                  children: [
                                                    Text(
                                                        "-Select the size of Ingredients-"),
                                                  ],
                                                ),
                                                value:
                                                    _selectedSize2, // Set the selected value here
                                                onChanged: (newValue) {
                                                  setState(() {
                                                    _selectedSize2 =
                                                        newValue; // Update the selected value
                                                ...
                                                items: [
                                                  ...
                                                  DropdownMenuItem(
                                                    ...
                                                    value:
                                                        "Pepperoni", // You can set the value to the option text
                                                  ),
                                                  DropdownMenuItem(
                                                    child: Text("Salty"),
                                                    value: "Salty",
                                            ...
                                            children: [
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: InkWell(
                                                    onTap: () {
                                                      // Navigate to the cart_page.dart route
                                                        ...
                                                        children: [
                                                          ...
                                                          SizedBox(
                                                              ...
                                                              child:
                                                                  ElevatedButton(
                                                                onPressed: () {
                                                                  _addToCart(); // Call the _addToCart function when the button is pressed
                                                                },
                                                                child: Row(
                                                                  mainAxisAlignment:
                                                                      MainAxisAlignment
