...
class IndividualItem4 extends StatefulWidget {
  static const routeName = "/mostpopular1";

  @override
  _IndividualItemState createState() => _IndividualItemState();
}

class _IndividualItemState extends State<IndividualItem4> {
  String? _selectedSize1;
  String? _selectedSize2;
  int _portionCount = 1;
  int _initialPrice = 650;
  int _totalPrice = 650;
  String _itemName = "Cafe De Bambaa";

  void _addToCart() {
  print("Adding to cart: $_itemName"); // Add this line for debugging
  _itemName = "Cafe De Bambaa x$_portionCount Rs.$_totalPrice";
