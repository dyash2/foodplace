...
class IndividualItem5 extends StatefulWidget {
  static const routeName = "/mostpopular2";

  @override
  _IndividualItemState createState() => _IndividualItemState();
}

class _IndividualItemState extends State<IndividualItem5> {
  String? _selectedSize1;
  String? _selectedSize2;
  int _portionCount = 1;
  int _initialPrice = 400;
  int _totalPrice = 400;
  String _itemName = "Sandwich by Bella";

  void _addToCart() {
  print("Adding to cart: $_itemName"); // Add this line for debugging
  _itemName = "Sandwich by Bella x$_portionCount Rs.$_totalPrice";
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: [
                ...
                DropdownMenuItem(
                  child: Text("Banana"),
                  value: "Banana", // You can set the value to the option text
                ),
                DropdownMenuItem(
