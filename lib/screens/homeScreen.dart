...
import 'package:foodplace/screens/Items/m1.dart';
import 'package:foodplace/screens/Items/m2.dart';
import 'package:foodplace/screens/Items/r1.dart';
import 'package:foodplace/screens/Items/r2.dart';
import 'package:foodplace/screens/Items/r3.dart';
import 'package:foodplace/screens/loginScreen.dart';
import '../const/colors.dart';
import '../utils/helper.dart';
import '../widgets/customNavBar.dart';
import 'Items/in1.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor:
              appBarBackgroundColor, // Change this to your desired background color
          actions: [
            Align(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.of(context)
                            .pushNamed(IndividualItem6.routeName);
                      },
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.of(context)
                            .pushNamed(IndividualItem7.routeName);
                      },
                      child: RestaurantCard(
                        image: Image.asset(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.of(context)
                            .pushNamed(IndividualItem8.routeName);
                      },
                      child: RestaurantCard(
                        image: Image.asset(
                        ...
                        child: Row(
                          children: [
                            GestureDetector(
                              onTap: () {
                                Navigator.of(context)
                                    .pushNamed(IndividualItem4.routeName);
                              },
                            ...
                            GestureDetector(
                                onTap: () {
                                  Navigator.of(context)
                                      .pushNamed(IndividualItem5.routeName);
                                },
                                child: MostPopularCard(
                                  name: "Sandwich by Bella",
                                  image: Image.asset(
                      ...
                      child: Column(
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.of(context)
                                  .pushNamed(IndividualItem2.routeName);
                            },
                            child: RecentItemCard(
                              image: Image.asset(
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.of(context)
                                  .pushNamed(IndividualItem3.routeName);
                            },
                            child: RecentItemCard(
                              image: Image.asset(
